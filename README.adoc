= Couchbase Columnar Go SDK Documentation

This repository hosts the documentation source for the
https://docs.couchbase.com/analytics-go-sdk/1.0/hello-world/overview.html[Enterprise Analytics Go SDK Documentation].


This branch documents the 1.0 release of the SDK.
It follows the https://docs.couchbase.com/analytics-go-sdk/1.0/project-docs/compatibility.html#api-version[Enterprise Analytics SDK 1.0 API].
...
| `name-sdk:` | Allows us to name the SDK within shared content (*Go Columnar SDK*).
