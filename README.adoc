...
https://docs.couchbase.com/columnar-go-sdk/1.0/hello-world/overview.html[Couchbase Columnar Go SDK Documentation].


This branch documents the 1.0 release of the SDK.
It follows the https://docs.couchbase.com/columnar-go-sdk/1.0/project-docs/compatibility.html#api-version[columnar SDK 1.0 API].
