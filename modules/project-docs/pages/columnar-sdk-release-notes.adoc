...
:description: Release notes, brief installation instructions, and download archive for the Capella Columnar Go Client.
...
Version {sdk_dot_minor} of the Go Columnar SDK implements the {sdk_api} xref:compatibility.adoc#api-version[SDK API].
...
This is the first General Availability (GA) release of the new Couchbase Columnar Go SDK.
It supports executing queries against Capella Columnar clusters, with additional features planned for future releases.

https://docs.couchbase.com/sdk-api/couchbase-columnar-go-client-1.0.0/[API Reference]
// end::all[]
